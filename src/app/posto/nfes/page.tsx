...
export default function NfesPostoPage() {
  const nfes = useMemo(() => NFES.filter((n) => n.destinatarioId === POSTO_LOGADO_ID), [])
  ...
  return (
    <div style={{ display: 'grid', gap: 24 }}>
      <SectionHeader
        eyebrow={`${nfes.length} notas emitidas`}
        title="Notas fiscais eletrônicas"
        subtitle="Compliance fiscal completo: ICMS, PIS, COFINS e CIDE calculados automaticamente em cada operação."
      />

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24 }}>
        <Card>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', color: 'var(--tanqe-gray)', margin: 0, marginBottom: 8 }}>Total faturado</p>
        ...
        <Card>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', color: 'var(--tanqe-gray)', margin: 0, marginBottom: 8 }}>Impostos recolhidos</p>
        ...
        <Card>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', color: 'var(--tanqe-gray)', margin: 0, marginBottom: 8 }}>Notas emitidas</p>
          <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 28, color: 'var(--tanqe-black)', letterSpacing: '-0.02em', lineHeight: 1 }}>{nfes.length}</div>
        </Card>
      </div>
        ...
        {nfes.length === 0 && (
          <Card>
            <p style={{ fontFamily: 'var(--font-body)', color: 'var(--tanqe-gray)', textAlign: 'center', padding: 32 }}>
              Nenhuma NF-e emitida ainda. As notas são geradas automaticamente após confirmação de pagamento.
            </p>
          </Card>
        )}
      </div>
    ...
    >
      ...
      <div style={{ padding: '20px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 24, paddingBottom: 20, borderBottom: '1px solid var(--tanqe-stone)' }}>
          <div>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', color: 'var(--tanqe-gray)', margin: 0, marginBottom: 6 }}>Emitente</p>
        ...
        <div style={{ background: 'var(--tanqe-cream)', borderRadius: 4, padding: 16, marginTop: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 12 }}>
            ...
            <KV label="Valor líquido" value={formatBRL(liquido)} small highlight />
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <p
        style={{
          ...
          fontWeight: 600,
          margin: 0,
          color: highlight ? 'var(--tanqe-orange)' : 'var(--tanqe-black)',
        }}
      >
        {value}
      </p>
